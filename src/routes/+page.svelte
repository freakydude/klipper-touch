<script lang="ts">
  ...
  import { faPause, faStop, faSkull, faGear, faDownLong, faArrowsUpDown } from '@fortawesome/free-solid-svg-icons';
...
<div class="flex w-full flex-col flex-wrap items-stretch gap-2 border-t-2 border-green-400 bg-neutral-800 p-1">
  ...
  <div class="flex flex-grow flex-col flex-wrap items-stretch justify-end gap-1 p-1">
    <button class="flex rounded border-l-4 border-purple-400 bg-neutral-600 px-1 py-2 text-white hover:bg-neutral-500" on:click={() => goto('/toolhead')}>
      ...
      <div class="flex-grow pr-1 text-end">Extruder</div>
    </button>
