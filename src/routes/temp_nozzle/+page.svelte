...
<div class="flex flex-grow flex-row border-t border-red-400 bg-neutral-800">
  <div class="flex w-3/4 flex-col items-center justify-around gap-1 p-1">
    <span class="flex w-full flex-row justify-center">
      <button class="flex rounded border-l-4 border-red-400 bg-neutral-700 py-2 text-white hover:bg-neutral-500 disabled:text-neutral-500">
  ...
  <div class="flex w-1/4 flex-col flex-wrap justify-around gap-1 p-1">
    <span class="flex flex-col flex-wrap justify-center gap-1">
      <button class="flex rounded border-l-4 border-blue-400 bg-neutral-700 px-1 py-2 text-white hover:bg-neutral-500" on:click="{() => goto('/temp_bed')}">
        ...
        <div class="flex-grow pl-2 pr-1 text-end">{$bedTempTarget.toFixed(0)} °C</div>
      </button>
