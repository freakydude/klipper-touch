...
!(function () {
  ...
  var T = R(
      ...
      s(c, L, { fa: 'solid', fass: 'solid', 'fa-solid': 'solid', fasr: 'regular', 'fa-regular': 'regular' }),
      c)
    ),
    D = R(
      (s((f = {}), I, { solid: 'fas', regular: 'far', light: 'fal', thin: 'fat', duotone: 'fad', brands: 'fab', kit: 'fak' }),
      s(f, L, { solid: 'fass', regular: 'fasr' }),
      f)
    ),
    F = R(
      (s((u = {}), I, { fab: 'fa-brands', fad: 'fa-duotone', fak: 'fa-kit', fal: 'fa-light', far: 'fa-regular', fas: 'fa-solid', fat: 'fa-thin' }),
    ...
    X = R((s((c = {}), I, { 900: 'fas', 400: 'far', normal: 'far', 300: 'fal', 100: 'fat' }), s(c, L, { 900: 'fass', 400: 'fasr' }), c)),
  ...
  function gt(t, a, e, n) {
    for (var i, r, o = Object.keys(t), s = o.length, c = void 0 !== n ? ht(a, n) : a, f = void 0 === e ? ((i = 1), t[o[0]]) : ((i = 0), e); i < s; i++)
      f = c(f, t[(r = o[i])], r, t);
    return f;
  }
  var ht = function (i, r) {
  ...
  function Zt(t) {
    ...
    d && (b.attributes[O] = ''),
      c &&
        (b.children.push({ tag: 'title', attributes: { id: b.attributes['aria-labelledby'] || 'title-'.concat(l || at()) }, children: [c] }),
      ...
      s
        ...
        : ((g = (v = t).children),
          ...
          ot((v = v.transform)) &&
            ...
            (y = 0.5),
            (h.style = rt(k(k({}, t), {}, { 'transform-origin': ''.concat(p + v.x / 16, 'em ').concat(y + v.y / 16, 'em') })))),
  ...
  function ra(t) {
    oa.mark(''.concat(sa, ' ').concat(t, ' ends')),
      oa.measure(''.concat(sa, ' ').concat(t), ''.concat(sa, ' ').concat(t, ' begins'), ''.concat(sa, ' ').concat(t, ' ends'));
  }
          ...
          et(t).forEach(function (t) {
            ...
            'childList' === t.type && 0 < t.addedNodes.length && !la(t.addedNodes[0]) && (J.searchPseudoElements && s(t.target), r(t.target)),
              ...
              'attributes' === t.type &&
                ...
                ((e = t.target), (n = e.getAttribute ? e.getAttribute(C) : null), (e = e.getAttribute ? e.getAttribute(S) : null), n && e)
  ...
  function xa(t, a) {
    var e = 1 < arguments.length && void 0 !== a ? a : { styleParser: !0 },
      ...
      s =
        ...
        J.autoA11y &&
          (n ? (a['aria-labelledby'] = ''.concat(J.replacementClass, '-title-').concat(s || at())) : ((a['aria-hidden'] = 'true'), (a.focusable = 'false'))),
        a),
    ...
    if (t) {
      ...
      return Qt(k({ type: 'icon' }, t), function () {
        return (
          ...
          J.autoA11y &&
            (s ? (l['aria-labelledby'] = ''.concat(J.replacementClass, '-title-').concat(c || at())) : ((l['aria-hidden'] = 'true'), (l.focusable = 'false'))),
          Zt({
        ...
        (t.i2svg = function (t) {
          ...
          (t.generateAbstractIcon = function (t) {
            ...
            return (
              ...
              ot(r) && (a = qt('generateAbstractTransformGrouping', { main: i, transform: r, containerWidth: i.width, iconWidth: i.width })),
              e.push(a || i.icon),
            ...
            return Qt({ type: 'counter', content: i }, function () {
              return (
                ...
                (t = {
                  content: i.toString(),
                  title: o,
                  extra: { attributes: c, styles: f, classes: [''.concat(J.cssPrefix, '-layers-counter')].concat(l(s)) }
                }),
                (a = t.content),
                (e = t.title),
                (n = t.extra),
            ...
            return Qt({ type: 'text', content: t }, function () {
              return (
                ...
                $t({
                  ...
                  transform: k(k({}, $), n),
                  title: i,
                  extra: { attributes: o, styles: s, classes: [''.concat(J.cssPrefix, '-layers-text')].concat(l(r)) }
                })
              );
            });
          }
      ...
      u && 'none' !== d && '' !== d
        ? ((s = l.getPropertyValue('content')),
          ...
          (d = (l =
            ...
            (s = (m = l).length),
            (c =
              55296 <= (d = m.charCodeAt(a)) && d <= 56319 && a + 1 < s && 56320 <= (c = m.charCodeAt(a + 1)) && c <= 57343
          ...
          l &&
            ((d = jt[(l = d)]),
            (l = Lt('fas', l)),
            (l = d || (l ? { prefix: 'fas', iconName: l } : null) || { prefix: null, iconName: null }).iconName &&
              l.prefix &&
      ...
      },
      {
        ...
        provides: function (t) {
          t.generateAbstractMask = function (t) {
            ...
            return (
              a.push(o, { tag: 'rect', attributes: k({ fill: 'currentColor', 'clip-path': 'url(#'.concat(r, ')'), mask: 'url(#'.concat(f, ')') }, Ta) }),
