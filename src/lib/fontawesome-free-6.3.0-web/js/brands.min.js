...
!(function () {
  ...
  r(
    ...
    M(o, L, { fa: 'solid', fass: 'solid', 'fa-solid': 'solid', fasr: 'regular', 'fa-regular': 'regular' }),
    o)
  );
  var t = r(
      (M((i = {}), V, { solid: 'fas', regular: 'far', light: 'fal', thin: 'fat', duotone: 'fad', brands: 'fab', kit: 'fak' }),
      M(i, L, { solid: 'fass', regular: 'fasr' }),
      i)
    ),
    m =
      (r(
        (M((z = {}), V, { fab: 'fa-brands', fad: 'fa-duotone', fak: 'fa-kit', fal: 'fa-light', far: 'fa-regular', fas: 'fa-solid', fat: 'fa-thin' }),
      ...
      r((M((l = {}), V, { 900: 'fas', 400: 'far', normal: 'far', 300: 'fal', 100: 'fat' }), M(l, L, { 900: 'fass', 400: 'fasr' }), l)),
